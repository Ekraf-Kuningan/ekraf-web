        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16 md:h-18">
                ...
                <div class="hidden lg:flex items-center space-x-6">
                    ...
                    @auth
                        ...
                        <div class="relative group">
                            <button class="flex items-center space-x-2 px-3 py-2 bg-white/20 rounded-full hover:bg-white/30 transition-all duration-200">
                                <i class="fas fa-user-circle text-white text-lg"></i>
                                <span class="text-white font-medium text-sm">{{ Str::limit(auth()->user()->name, 10) }}</span>
                                <i class="fas fa-chevron-down text-white text-xs group-hover:rotate-180 transition-transform duration-200"></i>
                            </button>
                            
                            <!-- Dropdown Menu -->
                            <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0">
                                <div class="py-2">
                ...
                <div class="flex items-center space-x-2 lg:hidden">
                    ...
                    <button id="search-toggle" class="p-2 text-white hover:bg-white/20 rounded-lg transition-colors md:hidden">
                        <i class="fas fa-search text-lg"></i>
                    </button>
                    
                    <!-- Enhanced Hamburger Menu -->
                    <button id="mobile-menu-toggle" class="relative p-2 text-white hover:bg-white/20 rounded-lg transition-all duration-300 focus:outline-none group">
                        <div class="w-6 h-6 flex flex-col justify-center items-center">
                            <span class="hamburger-line hamburger-line-1 block w-6 h-0.5 bg-white transition-all duration-300 ease-in-out"></span>
                            <span class="hamburger-line hamburger-line-2 block w-6 h-0.5 bg-white transition-all duration-300 ease-in-out mt-1.5"></span>
                            <span class="hamburger-line hamburger-line-3 block w-6 h-0.5 bg-white transition-all duration-300 ease-in-out mt-1.5"></span>
                        </div>
                    </button>
                </div>
            </div>
                ...
                @auth
                    ...
                    <div class="border-t border-gray-200 mt-4 pt-4">
                        ...
                        <form method="POST" action="{{ route('logout') }}" class="mt-3">
                            @csrf
                            <button type="submit" 
                                    class="mobile-nav-link logout w-full text-left">
...
=======
    ...
    <style>
        ...
        .nav-link {
            @apply flex items-center space-x-1 text-sm font-medium text-green-900 hover:text-white transition-all duration-200 px-3 py-2 rounded-lg hover:bg-white/20;
        }
        ...
        .mobile-nav-link {
            @apply flex items-center space-x-3 px-3 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 rounded-lg transition-all duration-200;
        }
        ...
        /* Menu Open State - Smooth X Animation */
