...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="{{ route('mitra.katalog') }}" class="inline-flex items-center text-gray-600 hover:text-orange-600 transition">
    ...
    @if($relatedProducts->count() > 0)
        <div class="mb-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('mitra.katalog', ['sub_sektor' => $product->sub_sektor_id]) }}" class="text-orange-600 hover:text-orange-700 font-medium">
                    Lihat Semua
                ...
                @foreach($relatedProducts as $related)
                    <div class="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden group">
                        ...
                        <div class="p-4">
                            ...
                            <!-- Actions -->
                            <a 
                                href="{{ route('mitra.katalog.show', $related->id) }}" 
