...
@section('page_title', 'Tambah Produk Pelaku Ekraf')
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-8">
            <a href="{{ route('pelaku-ekraf.products') }}" class="inline-flex items-center text-sm text-gray-600 hover:text-orange-600 mb-4 transition-colors">
            ...
            <p class="mt-2 text-gray-600">Lengkapi informasi produk Anda dengan detail yang jelas</p>
        </div>

        <!-- Form Card -->
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            <form action="{{ route('pelaku-ekraf.products.store') }}" method="POST" enctype="multipart/form-data" class="p-6 md:p-8">
                @csrf
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ old('sub_sektor_id') == $category->id ? 'selected' : '' }}>
                                            {{ $category->title }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="text-sm text-blue-800">
                                ...
                                <ul class="list-disc list-inside space-y-1">
                                    <li>Produk yang Anda tambahkan akan melalui proses verifikasi oleh admin</li>
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t border-gray-200">
                    ...
                    <a 
                        href="{{ route('pelaku-ekraf.products') }}" 
...
<script>
    ...
    const oldBusinessCategory = "{{ old('business_category_id') }}";
    ...
    nameInput.addEventListener('blur', function() {
        ...
        nameCheckTimeout = setTimeout(() => {
            fetch('{{ route("pelaku-ekraf.products.check-name") }}', {
                method: 'POST',
                headers: {
