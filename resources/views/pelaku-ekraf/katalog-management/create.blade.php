...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <!-- Header -->
    <div class="mb-8">
        <a href="{{ route('pelaku-ekraf.katalog-management.index') }}" class="inline-flex items-center text-gray-600 hover:text-orange-600 transition mb-4">
    ...
    <!-- Form -->
    <form action="{{ route('pelaku-ekraf.katalog-management.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            @else
                <div class="text-center py-8 bg-yellow-50 border border-yellow-200 rounded-lg">
                    ...
                    <a href="{{ route('pelaku-ekraf.products.create') }}" class="inline-flex items-center px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition">
