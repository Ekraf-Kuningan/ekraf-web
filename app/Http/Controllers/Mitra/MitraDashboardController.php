...
{
	/**
	 * Dashboard utama untuk Mitra (UMKM)
	 */
	public function index()
	{
		$user = Auth::user();

		// Ambil profil mitra jika ada (untuk ucapan selamat datang)
		...
		return view('mitra.dashboard', compact('mitra', 'stats', 'categories', 'products', 'latestProducts', 'notifications', 'katalogsBySubSektor','totalViews',
        'viewsThisMonth',
        'viewsToday',
        'topViewedKatalogs',
        'deviceStats',
