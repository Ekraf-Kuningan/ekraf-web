...
class PelakuEkrafProductController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pelaku-ekraf.products.index', compact('products', 'categories', 'stats'));
    }
    ...
    {
        $categories = SubSektor::orderBy('title')->get();
        return view('pelaku-ekraf.products.create', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pelaku-ekraf.products')
    ...
    public function show(Product $product)
    {
        ...
        return view('pelaku-ekraf.products.show', compact('product'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        $categories = SubSektor::orderBy('title')->get();
        return view('pelaku-ekraf.products.edit', compact('product', 'categories'));
    }
